import { ourCareerData } from '../../data/indoSoulLiveData'
    ...
    return (
        <div className='w-full'>
            <div className='w-full flex justify-center items-center pb-10 md:pb-20'>
                <h1 className='bg-clip-text text-transparent bg-gradient-to-r from-[#8B0000] to-[#CC0000] uppercase text-5xl leading-none font-bebasNeue tracking-widest'>the musicians</h1>
            </div>
