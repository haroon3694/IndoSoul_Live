...
const Sidebar: React.FC = () => {
    ...
    return (
        <>
            ...
            <div className={`w-[85%] bg-[#282827] rounded-[20px] flex justify-center items-center lg:hidden ${sidebarOpen ? '' : 'translate-x-[130%]'} z-20 fixed bottom-4 top-4 right-4 transition-all duration-500 ease-in-out`}>
