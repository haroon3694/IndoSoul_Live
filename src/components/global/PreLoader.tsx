...
const PreLoader = () => {
    ...
    return (
        <div className={`w-full fixed z-40 top-0 flex justify-center items-center bg-black transition-all duration-700 ease-in-out ${preLoaderActive ? 'min-h-screen' : 'min-h-0'}`}>
