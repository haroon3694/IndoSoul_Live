...
const CollaborateButton = ({ text, styles }: { text: string, styles?: string }) => {
    return (
        <div className='bg-gradient-to-r from-[#96D312] to-[#E92F2F] p-[2px] rounded-lg group hover:bg-transparent'>
